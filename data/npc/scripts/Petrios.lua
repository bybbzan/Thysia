...
---------------------------- help ------------------------
	if msgcontains(msg, 'bank account') then
		npcHandler:say({
			'Every player has one. The big advantage is that you can access your money in every branch of the local bank! ...',
...
npcHandler:setMessage(MESSAGE_GREET, 'Welcome to the local {bank}, |PLAYERNAME|! What can I do for you?')
